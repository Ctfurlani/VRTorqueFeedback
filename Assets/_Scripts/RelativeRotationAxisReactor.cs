...
namespace Ardunity
{	
	[AddComponentMenu("ARDUnity/Reactor/Transform/RelativeRotationAxisReactor")]
    [HelpURL("https://sites.google.com/site/ardunitydoc/references/reactor/rotationaxisreactor")]
	public class RelativeRotationAxisReactor : ArdunityReactor
	{
		public Axis upAxis;
		public Axis forwardAxis;
		public bool invert = false;
        public Transform relativeBaseTransform;
		...
		protected override void Awake()
		{
            ...
            _initRot = relativeBaseTransform.rotation; //was transform.localRotation
		...
		void Update ()
		{
			if(_analogInput != null || _analogOutput != null || _dragInput != null)
			{
                ...
                {
                    //TODO change this line to account for max angle, mass and hand angle
